\section{Document Writing Guidelines}
\label{document-writing-guidelines}
...
\subsection{Feminization of French Text}
\label{feminization-of-french-text}
...
\subsubsection{Tasks and Responsibilities}
\label{tasks-and-responsibilities-1}

\section{Finances and Membership}
\label{finances-and-membership}

\subsection{Applications for Membership}
\label{applications-for-membership}
...
\subsection{Activity Surpluses and Deficits}
\label{activity-surpluses-and-deficits}

\subsubsection{Activity Fund}
\label{activity-fund}
...
\subsubsection{Use of Funds to Cover Activity Surpluses}
\label{use-of-funds-to-cover-activity-surpluses}
...
\subsubsection{Use of Funds to Cover Activity Deficits}
\label{use-of-funds-to-cover-activity-deficits}
...
\subsection{Use of Funds from the Activity Fund}
\label{use-of-funds-from-the-activity-fund}

\subsubsection{Excess Funds}
\label{excess-funds}
...
\subsubsection{Activity Fund Loans}
\label{activity-fund-loans}
...
\subsection{Banking Requirements}
\label{banking-requirements}

\subsubsection{Signing Authorities}
...
\subsubsection{Current Signing Authority Breakdown}
\label{current-signing-authority-breakdown}
...
\subsection{Delegate Fee Collection}
\label{delegate-fee-collection}
...
\subsection{CFES Activity Bank Accounts}
\label{cfes-activity-bank-accounts}
...
\subsection{Financial Deliverables}
\label{financial-deliverables}

\subsubsection{Board Meetings}
\label{board-meetings}

\begin{enumerate}
 \item
  The Vice President Finance and Administration shall include a Financial Updates section in the Board Meeting Agenda, covering all activity and transactions that have occurred in any Federation account up to seven (7) days prior to the Board Meeting.
 \item
  Financial updates shall include the activity, ledger year category, and relevant date of each transaction.
 \item
  Withdrawals and deposits within the same category shall be reported separately, not as a net amount.
 \item
  Presenting detailed financial statements at Board Meetings shall also include:

  \begin{enumerate}
   \item
    an accounting of all outgoing transactions of less than \$1,000; and
   \item
...
\subsubsection{Financial Reports}
\label{financial-reports}

\begin{enumerate}
 \item
  A Financial Report must be provided by the VPFA to the Membership no later than two (2) weeks after the conclusion of the previous month, detailing:

...
\subsection{Applications for
 Membership}\label{applications-for-membership}
...
\subsubsection{Use of Funds to Cover Activity
 Surpluses}\label{use-of-funds-to-cover-activity-surpluses}
...
\subsubsection{Use of Funds to Cover Activity
 Deficits}\label{use-of-funds-to-cover-activity-deficits}

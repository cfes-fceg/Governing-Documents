...
\subsection{Annual Elections at CELC}
\label{annual-elections-at-celc}
...
\subsubsection{Activity Bid Invitations}
\label{activity-bid-invitations}
...
\subsection{Chief Returning Officer}
...
\subsubsection{Single Candidate Runoff Procedure}
\label{single-candidate-runoff-procedure}
...
\begin{enumerate}
 ...
 \item
  If there is only one candidate remaining, the Uncontested Elections procedures outlined in \ref{uncontested-elections} shall apply.
 \item
  Repeat steps 2--6 until one winner is declared.
\end{enumerate}

\subsubsection{Dual Candidate Runoff Procedure}
\label{dual-candidate-runoff-procedure}
...
\subsubsection{Uncontested Elections}
\label{uncontested-elections}

\begin{enumerate}
 \item
  An uncontested election occurs when there is only one candidate for a position.
 \item
  In an uncontested election, the candidate must receive a number of votes equal to or greater than the total number of votes cast, minus the number of votes cast by the largest regional delegation present.
 \item
  If the candidate does not meet this threshold, the position shall be declared vacant and filled in accordance with the applicable vacancy procedures.
\end{enumerate}
...
\subsubsection{By-Elections for National Executive and National Councillor Positions}
\label{by-elections-for-national-executive-and-national-councillor-positions}
...
\subsubsection{By-Elections for Host Schools}
\label{by-elections-for-host-schools}
...
\paragraph{Vacant Host School Positions}
\label{vacant-host-school-positions}

\section{Le financement et l'adhésion}
\label{le-financement-et-ladhuxe9sion}

\subsection{Les candidatures à l\textquotesingle adhésion}
\label{les-candidatures-uxe0-ladhuxe9sion}
...
\subsection{Les excédents et les déficits d\textquotesingle activité}
\label{les-excuxe9dents-et-les-duxe9ficits-dactivituxe9}

\subsubsection{Les fonds d\textquotesingle activités}
\label{les-fonds-dactivituxe9s}
...
\subsubsection{L'utilisation des fonds pour couvrir les excédents d\textquotesingle activité}
\label{lutilisation-des-fonds-pour-couvrir-les-excuxe9dents-dactivituxe9}
...
\subsubsection{L'utilisation des fonds pour couvrir les déficits d\textquotesingle activité}
\label{lutilisation-des-fonds-pour-couvrir-les-duxe9ficits-dactivituxe9}
...
\subsection{L'utilisation du fonds d\textquotesingle activité}
\label{lutilisation-du-fonds-dactivituxe9}

\subsubsection{Les fonds excédentaires}
\label{les-fonds-excuxe9dentaires}
...
\subsubsection{Les prêts du Fonds d'activité}
\label{les-pruxeats-du-fonds-dactivituxe9}
...
\subsection{Les exigences bancaires}
\label{les-exigences-bancaires}

\subsubsection{Les autorités de signature}
\label{les-autorituxe9s-de-signature}
...
\subsubsection{La répartition des pouvoirs de signature actuels}
\label{la-ruxe9partition-des-pouvoirs-de-signature-actuels}
...
\subsection{Perception des frais d\textquotesingle inscription des délégués}
\label{perception-des-frais-dinscription-des-duxe9luxe9guuxe9s}
...
\subsection{Comptes bancaires des activités de la FCEG Structure}
\label{comptes-bancaires-des-activituxe9s-de-la-fceg-structure}
...
\subsubsection{Pouvoirs de signature}
\label{pouvoirs-de-signature}
...
\subsubsection{Fonctionnalité}
\label{fonctionnalituxe9}
...
\subsubsection{Frais et limites}
\label{frais-et-limites}
...
\subsection{Résultats financiers attendus}
\label{resultats-financiers-attendus}

\subsubsection{Réunions du conseil d\textquotesingle administration}
\label{reunions-du-conseil-dadministration-financiers}

\begin{enumerate}
 \item
  Le/La vice-président.e aux finances et à l\textquotesingle administration doit inclure une section de mises à jour financières à l\textquotesingle ordre du jour de la réunion du Conseil d\textquotesingle administration, couvrant toutes les activités et transactions survenues dans tout compte de la Fédération jusqu\textquotesingle à sept (7) jours avant la réunion.
 \item
  Les mises à jour financières doivent inclure l\textquotesingle activité, la catégorie de l\textquotesingle année du grand livre et la date pertinente de chaque transaction.
 \item
  Les retraits et les dépôts relevant d\textquotesingle une même catégorie doivent être présentés séparément, et non comme un montant net.
 \item
  Présenter les états financiers détaillés lors des réunions du conseil d\textquotesingle administration, incluant également :

  \begin{enumerate}
   \item
    Un relevé de toutes les transactions sortantes de moins de 1 000 \$; et
   \item
    Les changements de tous les soldes de comptes depuis la précédente réunion.
  \end{enumerate}
\end{enumerate}

\subsubsection{Assemblées générales}
\label{assemblees-generales-financiers}

\begin{enumerate}
 \item
  Présenter les états financiers en détails lors des assemblées générales, qui incluent :

  \begin{enumerate}
   \item
    Un relevé de toutes les transactions sortantes de moins de 1 000 \$
   \item
    Les changements de tous les soldes de comptes depuis la dernière assemblée précédente
  \end{enumerate}
\end{enumerate}

\subsubsection{Rapports financiers}
\label{rapports-financiers}

\begin{enumerate}
 \item
  Un rapport financier doit être fourni par le VPFA aux membres au plus tard deux (2) semaines après la conclusion du mois précédent, détaillant :

  \begin{enumerate}
   \item
    Les fonds réels du mois dernier
   \item
    Les progrès sur les initiatives décrites dans le plan d\textquotesingle action du VPFA
   \item
    Le statut de tous les investissements, qu\textquotesingle ils soient existants ou nouveaux, ainsi qu\textquotesingle une valeur approximative pour chacun
   \item
    Dans les rapports financiers d\textquotesingle avril, juillet, octobre et janvier, les états financiers trimestriels
   \item
    Dans le rapport financier de juin, les états financiers non audités pour l\textquotesingle exercice précédent
   \item
    Les résultats de toute déclaration fiscale dans le mois suivant leur évaluation par l\textquotesingle ARC
   \item
    Tous les états financiers audités dans le mois suivant leur finalisation
  \end{enumerate}
\end{enumerate}

\section{Les élections}
\label{les-uxe9lections}

\subsection{Les élections annuelles du CCLI}
\label{les-uxe9lections-annuelles-du-ccli}
...
\subsubsection{Invitations aux appels d\textquotesingle offres pour des activités}
\label{invitations-aux-appels-doffres-pour-des-activituxe9s}
...
\subsection{Le/la directeur.e général.e des élections}
\label{lela-directeur.e-guxe9nuxe9ral.e-des-uxe9lections}
...
\subsection{La mise en candidature}
\label{la-mise-en-candidature}
...
\subsection{Les documents de campagne}
\label{les-documents-de-campagne}
...
\subsection{La période de questions}
\label{la-puxe9riode-de-questions}
...
\subsection{Le scrutin}
\label{le-scrutin}

\subsubsection{La procédure}
\label{la-procuxe9dure}
...
\begin{enumerate}
 ...
 \item
  S'il ne reste qu'une seule personne candidate, les procédures relatives aux élections sans opposition décrites à la \ref{les-uxe9lections-sans-opposition} s'appliquent.
 \item
  Les étapes 2 à 6 sont répétées.
\end{enumerate}

\subsubsection{La méthode de scrutin par élimination binominal}
\label{la-muxe9thode-de-scrutin-par-uxe9limination-binominal}
...
\subsubsection{Les élections sans opposition}
\label{les-uxe9lections-sans-opposition}

\begin{enumerate}
 \item
  Une élection sans opposition a lieu lorsqu'il n'y a qu'une seule personne candidate à un poste.
 \item
  Lors d'une élection sans opposition, la personne candidate doit recevoir un nombre de votes égal ou supérieur au nombre total de votes exprimés, moins le nombre de votes exprimés par la plus grande délégation régionale présente.
 \item
  Si la personne candidate n'atteint pas ce seuil, le poste est déclaré vacant et comblé conformément aux procédures de vacance applicables.
\end{enumerate}

\subsection{La ratification}
\label{la-ratification}
...
\subsection{Les élections partielles}
\label{les-uxe9lections-partielles}

\subsubsection{Les élections partielles pour un poste de membre de l'exécutif national ou de conseiller.ère national.e}
\label{les-uxe9lections-partielles-pour-un-poste-de-membre-de-lexuxe9cutif-national-ou-de-conseiller.uxe8re-national.e}
...
\subsubsection{Les élections partielles pour les écoles hôtes}
\label{les-uxe9lections-partielles-pour-les-uxe9coles-huxf4tes}

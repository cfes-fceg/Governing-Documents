...
\subsection{Objectif et survol}
\label{objectif-et-survol}
...
\subsection{La remise des prix au CCLI}
\label{la-remise-des-prix-au-ccli}

\subsubsection{La vue d\textquotesingle ensemble}
\label{la-vue-densemble}
...
\subsubsection{Le prix d'appréciation}
\label{le-prix-dappruxe9ciation}
...
\subsubsection{Le prix du leadership}
\label{le-prix-du-leadership}
...
\subsubsection{Le prix de bienfaisance}
\label{le-prix-de-bienfaisance}
...
\subsubsection{Le prix de reconnaissance pour les officiers}
\label{le-prix-de-reconnaissance-pour-les-officiers}
...
\subsubsection{Le prix du plaidoyer de la FCÉG}
\label{le-prix-du-plaidoyer-de-la-fcuxe9g}
...
\subsubsection{Le prix de la responsabilité environnementale}
\label{le-prix-de-la-responsabilituxe9-environnementale}
...
\subsection{Les prix remis au SCIP}
\label{les-prix-remis-au-scip}

\subsubsection{Le prix de reconnaissance pour l'activité exceptionnelle}
\label{le-prix-de-reconnaissance-pour-lactivituxe9-exceptionnelle}

\section{Le Conseil d\textquotesingle administration}
\label{le-conseil-dadministration}

\subsection{Les tâches et responsabilités}
\label{les-tuxe2ches-et-responsabilituxe9s}
...
\subsection{La conduite des directeur.trice.s}
\label{la-conduite-des-directeur.trice.s}

\subsubsection{La conduite}
\label{la-conduite}
...
\subsubsection{Les conflits d\textquotesingle intérêts pour les directeur.trice.s}
\label{les-conflits-dintuxe9ruxeats-pour-les-directeur.trice.s}
...
\subsection{Les séances à huis clos}
\label{les-suxe9ances-uxe0-huis-clos}
...
\subsection{L\textquotesingle ordre du jour et les comptes rendus des réunions du conseil}
\label{lordre-du-jour-et-les-comptes-rendus-des-reunions-du-conseil}

\subsubsection{Structure de l\textquotesingle ordre du jour}
\label{structure-de-lordre-du-jour}

\begin{enumerate}
 \item
  Les sections de fond de l\textquotesingle ordre du jour sont, dans l\textquotesingle ordre~:
  ...
  \begin{enumerate}
   ...
   \item
    Avis de motions futures et autres affaires
  \end{enumerate}

\end{enumerate}

\subsubsection{Distribution de l\textquotesingle ordre du jour}
\label{distribution-de-lordre-du-jour}

\begin{enumerate}
 \item
  L\textquotesingle ordre du jour de la réunion du Conseil d\textquotesingle administration doit être communiqué aux membres du conseil et aux responsables d\textquotesingle activités au plus tard sept (7) jours avant la réunion.
 \item
  L\textquotesingle ordre du jour doit être finalisé au plus tard soixante-douze (72) heures avant la réunion.
 \item
  Une copie de l\textquotesingle ordre du jour, incluant toutes les motions non confidentielles, peut être communiquée aux membres après la finalisation de l\textquotesingle ordre du jour.
\end{enumerate}

\subsubsection{Les comptes rendus}
\label{les-comptes-rendus-reunions}

\paragraph{Comptes rendus des activités}
\begin{enumerate}
 \item
  Les responsables d\textquotesingle activités doivent s\textquotesingle assurer que leurs comptes rendus sont ajoutés à l\textquotesingle ordre du jour au plus tard soixante-douze (72) heures avant la réunion.
 \item
  Les comptes rendus doivent inclure toutes les activités relevant du portefeuille de l\textquotesingle activité depuis la dernière fois que des comptes rendus ont été fournis.
 \item
  Les comptes rendus relatifs à des activités survenues entre leur ajout à l\textquotesingle ordre du jour et la réunion peuvent être présentés en direct lors de la réunion et consignés au procès-verbal, ou ajoutés aux comptes rendus de la réunion suivante du Conseil d\textquotesingle administration.
 \item
  Les responsables d\textquotesingle activités sont tenu.e.s de faire le suivi de leurs activités tout au long de leur mandat afin que la rédaction des comptes rendus ne constitue pas une tâche ardue.
 \item
  Il n\textquotesingle existe aucune excuse raisonnable pour que les comptes rendus soient absents de l\textquotesingle ordre du jour avant sa finalisation. En cas d\textquotesingle autres engagements, de maladie, de vacances ou d\textquotesingle autres circonstances, les comptes rendus des travaux accomplis jusqu\textquotesingle à ce moment doivent tout de même être ajoutés à l\textquotesingle ordre du jour ou soumis au/à la vice-président.e aux services pour inclusion à l\textquotesingle ordre du jour.
\end{enumerate}

\paragraph{Comptes rendus du conseil}
\begin{enumerate}
 \item
  Les membres du Conseil d\textquotesingle administration doivent s\textquotesingle assurer que leurs comptes rendus sont ajoutés à l\textquotesingle ordre du jour au plus tard soixante-douze (72) heures avant la réunion.
 \item
  Les comptes rendus doivent inclure toutes les activités relevant du portefeuille du poste depuis la dernière fois que des comptes rendus ont été fournis.
 \item
  Les comptes rendus relatifs à des activités survenues entre leur ajout à l\textquotesingle ordre du jour et la réunion peuvent être présentés en direct lors de la réunion et consignés au procès-verbal, ou ajoutés aux comptes rendus de la réunion suivante du Conseil d\textquotesingle administration.
 \item
  Les membres du Conseil d\textquotesingle administration sont tenus de faire le suivi de leurs activités tout au long de leur mandat afin que la rédaction des comptes rendus ne constitue pas une tâche ardue.
 \item
  Il n\textquotesingle existe aucune excuse raisonnable pour que les comptes rendus soient absents de l\textquotesingle ordre du jour avant sa finalisation. En cas d\textquotesingle autres engagements, de maladie, de vacances ou d\textquotesingle autres circonstances, les comptes rendus des travaux accomplis jusqu\textquotesingle à ce moment doivent tout de même être ajoutés à l\textquotesingle ordre du jour ou soumis au/à la président.e du Conseil d\textquotesingle administration pour inclusion à l\textquotesingle ordre du jour.
\end{enumerate}

\paragraph{Comptes rendus financiers}
\begin{enumerate}
 \item
  Les mises à jour financières doivent être incluses à l\textquotesingle ordre du jour de la réunion du Conseil d\textquotesingle administration conformément à la politique \nameref{resultats-financiers-attendus}.
\end{enumerate}

\subsection{Les résolutions écrites}
\label{les-ruxe9solutions-uxe9crites}

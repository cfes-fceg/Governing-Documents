\section{Processus d'appel de la CCI}
\label{processus-dappel-de-la-cci}

\subsection{Appels concernant des changements qui touchent plus d'une CCI}
...
\subsection{Appels ayant une incidence sur la CCI actuel}

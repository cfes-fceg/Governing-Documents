\section{Les directives sur la rédaction des documents}
\label{les-directives-sur-la-ruxe9daction-des-documents}

\subsection{Les directives sur la traduction}
\label{les-directives-sur-la-traduction}
...
\subsection{La féminisation des textes en français}
\label{la-fuxe9minisation-des-textes-en-franuxe7ais}
...
\subsection{Le comité de gouvernance}
\label{le-comituxe9-de-gouvernance}

\subsubsection{La vue d\textquotesingle ensemble}
\label{la-vue-densemble-4}
...
\subsubsection{Les tâches et les responsabilités}
\label{les-tuxe2ches-et-les-responsabilituxe9s}

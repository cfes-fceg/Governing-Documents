...
\subsection{La cotisation}\label{la-cotisation}

\begin{enumerate}
 \item
  À partir de l\textquotesingle année 2021-2022, les cotisations sont dues le dernier jour du CCLI organisé au cours de l\textquotesingle année fiscale précédente (les cotisations pour 202X sont dues au cours de l\textquotesingle année fiscale 202(x-1)).
 \item
  Les factures sont émises le 1er septembre de l\textquotesingle année précédant la date d\textquotesingle échéance de la cotisation.
 \item
  Les exigences suivantes sont en vigueur en ce qui concerne les cotisations:

  \begin{enumerate}
   \item
    Une pénalité de 5\% par mois, jusqu\textquotesingle à un total de 20\% du montant total dû, s\textquotesingle applique si une école membre est en retard dans le paiement de sa cotisation.
   \item
    ...
    \end{enumerate}
   \item
    Une cotisation en retard et impayée affecte le statut de membre de l\textquotesingle association d\textquotesingle étudiants en ingénierie concernée au sein de la Fédération.
   \item
    L\textquotesingle école doit payer des frais d\textquotesingle observateur aux événements de la FCÉG et n\textquotesingle a pas le droit de vote jusqu\textquotesingle à ce que les frais d\textquotesingle adhésion, y compris toutes les pénalités applicables, soient payés.
   \item
    Une association d'étudiants en ingénierie qui n\textquotesingle a pas participé au Sommet du développement des associations en ingénierie ou au CCLI et qui n\textquotesingle a pas payé sa cotisation à temps doit être contactée par l\textquotesingle ambassadeur.drice régional.e concerné afin d\textquotesingle évaluer son avenir en tant que membre de la FCÉG.
   \item
    Un membre sera considéré comme exclu s\textquotesingle il ne paie pas sa cotisation à la FCÉG pendant deux années consécutives.
   \item
    Le/la président.e veillera à ce que la société comprenne les procédures d\textquotesingle adhésion à venir et le changement potentiel de statut.
   \item
    Les cotisations doivent être reçues par la FCÉG avant le début de la compétition régionale d\textquotesingle ingénierie pour que les membres puissent participer à la CCI.
  \end{enumerate}
\end{enumerate}
...
\subsection{La répartition des coûts d\textquotesingle audit de la FCÉG}\label{la-ruxe9partition-des-couxfbts-daudit-de-la-fcuxe9g}

\begin{enumerate}
 \item
  À partir de l\textquotesingle exercice fiscal 2020-2021, dans les années où la FCÉG est jugée nécessaire d\textquotesingle avoir une vérification, un examen ou une autre révision financière conforme à la loi sur les organismes à but non lucratif pertinente, le coût de la vérification sera réparti entre les parties suivantes de la manière suivante, à partir de 2019-2020, en augmentant chaque année par la suite avec l\textquotesingle indice des prix à la consommation (IPC) :

  \begin{enumerate}
   \item
    Le Sommet du développement des associations en ingénierie sera responsable de 10 \% des frais de vérification, jusqu\textquotesingle à 1000 \$ ;
   \item
    Le Congrès sur la diversité en ingénierie sera responsable de 15 \% des frais de vérification, jusqu\textquotesingle à 1500 \$ ;
   \item
    Le Congrès canadien sur le leadership en ingénierie sera responsable de 30 \% des frais de vérification, jusqu\textquotesingle à 3000 \$ ;
   \item
    Le Congrès sur le développement durable en ingénierie sera responsable de 15 \% des frais de vérification, jusqu\textquotesingle à 1500 \$ ;
   \item
    La Compétition canadienne d\textquotesingle Ingénierie sera responsable de 30 \% des frais de vérification, jusqu\textquotesingle à 3000 \$.
   \item
    La FCÉG est responsable du reste des frais d\textquotesingle audit, y compris les frais d\textquotesingle audit pour les activités qui utilisent les comptes financiers d\textquotesingle un organisme constitué en société, tels qu\textquotesingle approuvés par le Conseil d\textquotesingle administration, et pour les frais d\textquotesingle audit dépassant 10000 dollars.
  \end{enumerate}
 \item
  Dans le cas où le coût réel de la vérification est inférieur au montant contribué ci-dessus, la différence sera versée au Fonds d\textquotesingle activité.
\end{enumerate}

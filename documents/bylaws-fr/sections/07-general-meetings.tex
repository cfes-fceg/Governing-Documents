...
\label{lassembluxe9e-guxe9nuxe9rale}
...
\subsection{Le Sommet du développement des associations en ingénierie}
...
\subsection{Sommet canadien d'ingénierie du printemps}
\label{sommet-canadien-dinguxe9nierie-du-printemps}
...
\subsection{Le bootcamp d'été (Réunions non-générales)}
\label{le-bootcamp-duxe9tuxe9-ruxe9unions-non-guxe9nuxe9rales}
...
\subsection{Les Mises à jour saisonnières en ligne (MAJS-L)}
\label{les-mises-uxe0-jour-saisonniuxe8res-en-ligne-majs-l}
...
\subsection{Les lignes directrices pour les réunions}
\label{les-lignes-directrices-pour-les-ruxe9unions}

\subsubsection{Les appels de réunion}
\label{les-appels-de-ruxe9union}
...
\subsubsection{La traduction simultanée}
\label{la-traduction-simultanuxe9e}
...
\subsubsection{L'ordre du jour de la réunion}
\label{lordre-du-jour-de-la-ruxe9union}
...
\subsubsection{L'avis de réunion}
\label{lavis-de-ruxe9union}

\begin{enumerate}
 \item
  Un preavis écrit de vingt et un (21) jours sera donné à chaque membre de toute Assemblée générale.
 \item
...
\subsubsection{Le vote et le quorum}
\label{le-vote-et-le-quorum}
...
\subsubsection{Les droits de parole}
\label{les-droits-de-parole}
...
\subsubsection{La procuration}
\label{la-procuration}
...
\subsubsection{Le procès-verbal}
\label{le-procuxe8s-verbal}
...
\subsection{Le vote par correspondance}
\label{le-vote-par-correspondance}

\subsubsection{Les articles inéligibles}
\label{les-articles-inuxe9ligibles}
...
\subsection{Les vidéos à consulter avant l'assemblée générale}
\label{les-viduxe9os-uxe0-consulter-avant-lassembluxe9e-guxe9nuxe9rale}

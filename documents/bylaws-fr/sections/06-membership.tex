...
\subsection{Les cotisations}
\label{les-frais-dadhuxe9sion}

\subsubsection{Objectif}
\label{les-frais-dadhuxe9sion-objectif}
...
\subsubsection{Échéancier de perception}
\label{luxe9chuxe9ancier-de-perception}
\begin{enumerate}
...
\subsubsection{Cotisations impayées}
\label{les-frais-dadhuxe9sion-impayuxe9s}
\begin{enumerate}
...
\subsection{Les types de membres}
\label{les-types-de-membres}

\subsubsection{Les membres réguliers en règle}
\label{les-membres-ruxe9guliers-en-ruxe8gle}
...
\subsubsection{Les membres réguliers pas en règle}
\label{les-membres-ruxe9guliers-pas-en-ruxe8gle}
...
\subsubsection{Les membres observateurs}
\label{les-membres-observateurs}
...
\subsection{Le statut des membres}
\label{le-statut-des-membres}

\subsubsection{La suspension des membres}
\label{la-suspension-des-membres}
...
\subsubsection{L'expulsion des membres}
\label{lexpulsion-des-membres}
...
\subsubsection{La demande pour le statut de membre observateur}
\label{la-demande-pour-le-statut-de-membre-observateur}
...
\subsubsection{La demande de prolongation du statut de membre observateur}
\label{la-demande-de-prolongation-du-statut-de-membre-observateur}
...
\subsubsection{La procédure de retrait du statut de membre}
\label{la-procuxe9dure-de-retrait-du-statut-de-membre}
...
\subsubsection{La période de grâce}
\label{la-puxe9riode-de-gruxe2ce}
...
\subsubsection{L'appel d'une suspension ou d'une expulsion}
\label{lappel-dune-suspension-ou-dune-expulsion}
...
\subsection{Inscription des membres étudiant.e.s}
\label{inscription-des-membres-uxe9tudiant.e.s}

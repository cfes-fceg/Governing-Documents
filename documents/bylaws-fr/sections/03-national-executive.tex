\section{L'exécutif national}
\label{lexuxe9cutif-national}

\subsection{Le survol de l'exécutif national}
\label{le-survol-de-lexuxe9cutif-national}
...
\subsection{Le/la président.e}
\label{lela-pruxe9sident.e}
...
\subsection{Le/la vice-président.e académique (VPA)}
\label{lela-vice-pruxe9sident.e-acaduxe9mique-vpa}
...
\subsection{Le/la vice-président.e de finance et de l'administration (VPFA)}
\label{lela-vice-pruxe9sident.e-de-finance-et-de-ladministration-vpfa}
...
\subsubsection{Le/la vice-président.e sortant.e de finance et de l'administration}
\label{lela-vice-pruxe9sident.e-sortant.e-de-finance-et-de-ladministration}
...
\subsection{Le/la vice-président.e externe (VPE)}
\label{lela-vice-pruxe9sident.e-externe-vpe}
...
\subsection{Le/la vice-président.e des services (VPS)}
\label{lela-vice-pruxe9sident.e-des-services-vps}
 ...
 \item
  ...
  \begin{enumerate}
   ...
   \item
    ...
    \begin{enumerate}
     \item
      Y compris, mais sans s'y limiter, l'ensemble du calendrier des activités et les livrables finaux ; les rapports de transition du comité organisateur, la réunion de transition avec l'équipe sortante et l'équipe entrante et la clôture financière
    \end{enumerate}
   \item
   ...
   \item
    ...
    \begin{enumerate}
     \item
      Supervision et mise en œuvre de la procédure d'appel d'offres pour les activités
    \end{enumerate}
   \item
...
\subsection{Le/la vice-président.e des communications (VPC)}
\label{lela-vice-pruxe9sident.e-des-communications-vpc}
...
\label{les-postes-uxe0-pourvoir-1}
